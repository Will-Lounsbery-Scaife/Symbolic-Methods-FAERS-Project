...
#print(KEGG_find_query('polyethylene glycol 4000'))
...
# update dictionary with info from KEGG API requests
def AEOLUS_get_KEGG_info(results_dict):
    mycase = 1
    #results_dict = ID_search.add_AEOLUS_data_to_dictionary(mycase)
...
'''
    for reportID in F_KEGG_copy:
        ...
        icount += 1
        print(F_KEGG_copy[reportID]['drugs'])
