...
def read_results(results_fp):
    ...
    print("Data type after reconstruction : ", type(hw_dict))
    return(hw_dict)
            
results_dict_2 = read_results('/Users/loaner/Documents/GitHub/Symbolic-Methods-FAERS-Project/text_files/resdict_hw.txt')



print("iter3")
print("writing")
write_obj0 = open('text_files/resdict_hw.txt', 'w')
write_obj0.close()
results_obj0 = open('text_files/resdict_hw.txt', 'a')
    ...
    for pid in mydict:
        for drug in mydict[pid]["drugs"]:
            try:
                ...
                print("get_class_counts error", pid, mydict[pid], "\n\n")
    return class_counts
...
write_KEGG = open('text_files/KEGG_py.txt', 'w')
write_KEGG.close()
results_obj1 = open('text_files/KEGG_py.txt', 'a')
